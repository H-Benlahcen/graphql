...
//procédure de déconnection utilisateur
function Logout()
{
...
//procédure de connextion utilisateur
...
var update = 0
//création du diagramme de l'XP du GO
function generateGraphProgress(Progressdata)
{
  ...
  yAxisText.setAttribute("transform", `rotate(180) translate(${-svgHeight / 2}, 15)`);
...
//création du diagramme de l'XP global
